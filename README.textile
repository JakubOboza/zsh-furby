...
@zsh-furby@ should work with any recent release of "zsh":http://www.zsh.org/, the minimum recommended version is 4.2.7. You can check zsh version using @print $ZSH_VERSION@
